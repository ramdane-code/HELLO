# Script 9.1: Example-9-2-manual.py : test RESET sur Housing price equation
...
hprice1['fitted_sq'] = results.fittedvalues ** 2 # assigner fitted values² à nvelle col nommée 'fitted_sq'
hprice1['fitted_cub'] = results.fittedvalues ** 3 # idem pour 'fitted_cub'
...
# Script 9.2: Example-9-2-automatic.py (test RESET à l'aide de la commande **reset_ramsey)
import wooldridge as woo
import statsmodels.formula.api as smf
...
# Script 9.3: Nonnested-Test.py (test de modèles alternatifs non imbriqués)
import wooldridge as woo
import numpy as np
...
# Script 9.4: Sim-ME-Dep.py(simulation avec erreur de mesure sur y (peu dramatique))
import numpy as np
...
# Script 9.5: Sim-ME-Explan.py(simulation avec erreur sur variables indépendantes (graves conséquences))
import numpy as np
import scipy.stats as stats
import pandas as pd
import statsmodels.formula.api as smf
...
# Script 9.6 : NA-NaN-Inf.py (utiliser numpy pour tenir compte des valeurs manquantes)
import numpy as np
import pandas as pd
import scipy.stats as stats
...
# Script 9.7 : Missings.py (estimations avec des valeurs manquantes)	
import wooldridge as woo
import pandas as pd
...
# Script 9.8 : Missings-Analyses.py	(valeurs manquantes:comportements de Numpy et de Pandas)
import wooldridge as woo
import numpy as np
import statsmodels.formula.api as smf
...
# Script 9.9 : Outliers.py (répérer les valeurs aberrantes (outliers))	
import wooldridge as woo
import numpy as np
import statsmodels.api as sm
import statsmodels.formula.api as smf
...
# Script 9.10 : LAD.py(régression LAD (Least Absolute Deviation Estimation) comme alternative aux MCO) 	
import wooldridge as woo
import pandas as pd
import statsmodels.formula.api as smf

#Script 8.1: Example-8-2.py (estimation 'normale' et estimation robuste à l'hétéroscédasticité)
...
results_refined = reg.fit(cov_type='HCO')
...
# Script 8.2: Example-8-2-cont.py(tests F utilisant différentes formules de variance covariance)
import wooldridge as woo
import statsmodels.formula.api as smf
...
# Script 8.3: Example-8-4.py (versions F et LM du test Breusch_Pagan (BP))
import wooldridge as woo
import pandas as pd
...
# Script 8.4: Example-8-5.py(tests BP et de White pour modèle avec log des var dépend et indépendantes)
import wooldridge as woo
import numpy as np
import pandas as pd
import statsmodels.api as sm
...
# Script 8.5: Example-8-6.py (estimations MCO et WLS)
import wooldridge as woo
import pandas as pd
import statsmodels.formula.api as smf
...
# Script 8.6 : WLS-Robust.py (Estimation WLS plus  robust SE formula)	
import wooldridge as woo
import pandas as pd
import statsmodels.formula.api as smf
...
# Script 8.7: Example-8-7.py(test BP d'homoscédasticité et utilisation de la rég WLS)
import wooldridge as woo
import numpy as np
import pandas as pd
import statsmodels.api as sm

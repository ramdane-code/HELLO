...
# Script 16.1: Example-16-5-2SLS.py  (2SLS pour estimer un modèle d'équations simultanées)
...
# Script 16.2 : Example-16-5-3SLS.py (3SLS pour estimer un modèle d'équations simultanées)	
